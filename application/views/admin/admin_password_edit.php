...
<![endif]-->
<link type="text/css" rel="stylesheet" href="<?php echo $this->config->item('domain_static'); ?>static/h-ui/css/H-ui.css"/>
<link type="text/css" rel="stylesheet" href="<?php echo $this->config->item('domain_static'); ?>static/h-ui.admin/css/H-ui.admin.css"/>
...
<script type="text/javascript" src="<?php echo $this->config->item('domain_static'); ?>static/h-ui/js/H-ui.js"></script>
