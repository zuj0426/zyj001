...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" onclick="system_category_add('添加资讯','http://localhost/test/index.php/system/system_category_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
		</span>
