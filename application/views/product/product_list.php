...
<![endif]-->
<title>建材列表</title>
<link rel="stylesheet" href="<?php echo $this->config->item('domain_static'); ?>lib/zTree/v3/css/zTreeStyle/zTreeStyle.css" type="text/css">
</head>
<body class="pos-r">
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<tr class="text-c va-m">
						...
						<td class="text-l"><a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img title="国内品牌" src="<?php echo $this->config->item('domain_static'); ?>static/h-ui.admin/images/cn.gif"> <b class="text-success">圣象</b> 哥本哈根橡木地板KS8373</a></td>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<?php echo $this->config->item('domain_static'); ?>lib/zTree/v3/js/jquery.ztree.all-3.5.min.js"></script>
