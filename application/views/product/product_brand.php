		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td><img src="<?php echo $this->config->item('domain_static'); ?>temp/brand/dongpeng.jpeg"></td>
					<td class="text-l"><img title="国内品牌" src="<?php echo $this->config->item('domain_static'); ?>static/h-ui.admin/images/cn.gif"> 东鹏</td>
