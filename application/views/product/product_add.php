...
<link rel="Bookmark" href="<?php echo $this->config->item('domain_static'); ?>/favicon.ico" >
<link rel="Shortcut Icon" href="<?php echo $this->config->item('domain_static'); ?>/favicon.ico" />
<!--[if lt IE 9]>
...
<link href="<?php echo $this->config->item('domain_static'); ?>lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<script type="text/javascript" src="<?php echo $this->config->item('domain_static'); ?>lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="<?php echo $this->config->item('domain_static'); ?>lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="<?php echo $this->config->item('domain_static'); ?>lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="<?php echo $this->config->item('domain_static'); ?>lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '<?php echo $this->config->item('domain_static'); ?>lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '<?php echo $this->config->item('domain_static'); ?>lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('<?php echo $this->config->item('domain_static'); ?>lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
